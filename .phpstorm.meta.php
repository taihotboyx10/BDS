...
'debugbar.queries.explain','listings.index','listings.show','show.login',
'login','logout','show.register','register','verification.notice',
'verification.verify','verification.resend','realtor.listing.index','realtor.listing.create','realtor.listing.store',
'realtor.listing.show','realtor.listing.edit','realtor.listing.update','realtor.listing.destroy','realtor.listing.restore',
'realtor.listing.img.create','realtor.listing.img.store','realtor.listing.img.destroy','realtor.accept.offer','listing.offer.store',
'notification.index','notification.update','home','storage.local',);
